...
const questions: Question[] = [
  ...
  { category: "Class overlap", visual: "overlap", prompt: "In the demo, you move the two Gaussian means closer together. What should you expect to observe?", options: ["More overlap and usually lower test accuracy", "Less overlap and always perfect precision", "No change because KNN ignores feature values", "A guaranteed increase in both classes' accuracy"], answer: 0, explanation: "Moving the means closer makes green and red points overlap more. The plot and confusion matrix then normally show more classification errors.", experiment: "Move the green and red means toward each other while leaving K and the covariances unchanged." },
