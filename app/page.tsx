...
const questions: Question[] = [
  ...
  { category: "Training and test samples", visual: "split", prompt: "What should remain unchanged when you select “Test only” under the resampling controls?", options: ["The test points and the measured accuracy", "The solid training points and the decision boundary", "Every point in the feature space", "The test points but not the training points"], answer: 1, explanation: "The decision boundary is learned from the solid training points. Resampling only the outlined test points leaves both the training sample and the learned boundary fixed, while the measured accuracy can change.", experiment: "Press “Test only” several times. Watch the outlined points and accuracy, then confirm that the solid points and boundary stay fixed." },
  ...
  { category: "Predictor variance", visual: "resampling", prompt: "Pressing “Training only” repeatedly makes the K = 1 boundary move widely. What does this demonstrate?", options: ["High predictor variance", "Low predictor variance", "Perfect test accuracy", "No influence from the training sample"], answer: 0, explanation: "Predictor variance measures sensitivity to the particular training sample. Large boundary changes when only the training points are resampled are direct visual evidence of high variance.", experiment: "Set K = 1 and press “Training only” repeatedly. Then increase K and compare how much the boundary moves." },
